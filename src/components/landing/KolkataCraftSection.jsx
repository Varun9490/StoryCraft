...
import { kolkataCrafts } from '@/data/kolkata-crafts';

export default function KolkataCraftSection() {
    ...
    return (
        <section ref={ref} className="py-20 bg-[#0E0C08] overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 mb-10">
                ...
                >
                    <span className="text-[#52B788] text-xs uppercase tracking-[0.3em] font-medium">
                        Kolkata · West Bengal
                    </span>
                    <h2
                    ...
                    >
                        Stories Stitched in Thread & Clay
                    </h2>
                    <p className="text-sm text-white/40 mt-2 max-w-xl">
                        Bengal's crafts carry epics in every stitch and form — from Kantha quilts stitched with memories to Dokra bronzes cast by 4,500-year-old methods.
                    </p>
                </motion.div>
            </div>

            <div className="flex gap-6 px-6 overflow-x-auto scrollbar-hide pb-4">
                {kolkataCrafts.map((craft, i) => (
                    <motion.div
                        key={craft.id}
